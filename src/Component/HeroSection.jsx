...
import { ChevronDown, ArrowRight, Star, Home, Sparkles, Heart } from "lucide-react";
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div 
              ...
              style={{ 
                background: 'radial-gradient(circle, rgba(201, 184, 168, 0.4) 0%, transparent 70%)',
            ...
            <div 
              ...
              style={{ 
                background: 'radial-gradient(circle, rgba(228, 213, 196, 0.3) 0%, transparent 70%)',
            ...
            <div className="max-w-2xl">
              ...
              <div className="space-y-6 mb-12">
                ...
                >
                  <span 
                    style={{ 
                      background: 'linear-gradient(135deg, #E8D5C4 0%, #F5E6D3 50%, #FFF8F0 100%)',
                ...
                >
                  Transform your living space into a harmonious sanctuary with our thoughtful design solutions
                </p>
              </div>
              ...
              <button 
                ...
                style={{ 
                  background: 'linear-gradient(135deg, #8B7355 0%, #A68B5B 50%, #C9B8A8 100%)',
                  color: '#FDFCFA',
