    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: '#FAF8F5' }}>
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 mx-auto mb-4" style={{ borderColor: '#D79C66' }}></div>
      ...
      <div className="px-4 sm:px-6 lg:px-8 pb-12">
        <div className="flex flex-col lg:flex-row items-start max-w-7xl mx-auto gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center lg:w-1/2 w-full">
            ...
            >
              ...
              >
                <img
                  ref={imageRef}
                  className="rounded-xl w-full h-64 sm:h-80 lg:h-96 object-cover transition-transform duration-300 cursor-crosshair"
                  src={selectedImage}
                ...
                {showMagnifier && (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: '0 0 0 2px rgba(215, 156, 102, 0.8), inset 0 0 0 2px rgba(255,255,255,0.8)',
                      backgroundColor: '#FFFFFF'
                    }}
                  />
                )}
            ...
            <div className="flex flex-wrap justify-center mt-6 gap-2 sm:gap-3 max-w-md lg:max-w-lg">
              {getVisibleThumbnails().map((file, index) => (
                <div
                  ...
                  style={{
                    borderColor: selectedImage === file.url ? '#D79C66' : '#E1DDD7',
                    boxShadow: selectedImage === file.url ? '0 2px 8px rgba(215, 156, 102, 0.3)' : '0 1px 4px rgba(0,0,0,0.1)'
                  }}
          ...
          <div className="flex flex-col lg:w-1/2 w-full text-center lg:text-left">
            ...
            {/* Key Features */}
            <div className="mb-8">
              <h3 className="text-lg font-semibold mb-4" style={{ color: '#2B2B2B' }}>Key Features</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex items-center gap-2 justify-center lg:justify-start">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#D79C66' }}></div>
                  <span className="text-sm" style={{ color: '#6D6D6D' }}>Premium Quality</span>
                </div>
                <div className="flex items-center gap-2 justify-center lg:justify-start">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#D79C66' }}></div>
                  <span className="text-sm" style={{ color: '#6D6D6D' }}>Fast Delivery</span>
                </div>
                <div className="flex items-center gap-2 justify-center lg:justify-start">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#D79C66' }}></div>
                  <span className="text-sm" style={{ color: '#6D6D6D' }}>Easy Installation</span>
                </div>
                <div className="flex items-center gap-2 justify-center lg:justify-start">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#D79C66' }}></div>
                  <span className="text-sm" style={{ color: '#6D6D6D' }}>1 Year Warranty</span>
                </div>
              </div>
            </div>

            {/* Price Section - Responsive sizing */}
            <div className="mb-8 p-4 rounded-xl" style={{ backgroundColor: '#FFF8F5', border: '1px solid #E8E3DD' }}>
              <div 
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4 mb-8">
              <button
                ...
                style={{ backgroundColor: '#D79C66' }}
                onMouseOver={(e) => e.target.style.backgroundColor = '#C9854D'}
              ...
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m6.5-5v5a2 2 0 01-2 2H9a2 2 0 01-2-2v-5m8-5V8a2 2 0 00-2-2H9a2 2 0 00-2 2v1" />
                </svg>
                Add to Cart
              </button>
            </div>
            ...
            {/* Trust Badges */}
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4 sm:gap-6 pt-6 border-t" style={{ borderColor: '#E8E3DD' }}>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#D79C66' }} fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
                <span className="text-xs sm:text-sm" style={{ color: '#6D6D6D' }}>Secure Payment</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#D79C66' }} fill="currentColor" viewBox="0 0 20 20">
                  <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" />
                </svg>
                <span className="text-xs sm:text-sm" style={{ color: '#6D6D6D' }}>Free Shipping</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#D79C66' }} fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clipRule="evenodd" />
                </svg>
                <span className="text-xs sm:text-sm" style={{ color: '#6D6D6D' }}>Easy Returns</span>
              </div>
            </div>
          </div>
        </div>
